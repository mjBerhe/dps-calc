...
const Set1Calculations = () => {
   ...
   const { calcTotalBonuses, checkArclight, checkBlisterFlail, checkChaosGauntlets, checkDHCB, checkDHL, checkIvandisFlail, checkLeafBB, checkObbyNeck, checkObbySet, checkObbyWep, checkSalve, checkScythe, checkSlayerHelm, checkSlayerHelmImbued, checkSmokeStaff, checkTbow, checkTomeOfFire, checkVoid, checkWildy } = useEquippedGear();
   const { equipmentHasChanged, equippedWeapon, isArclight, isBlisterFlail, isChaosGauntlets, isDHCB, isDHL, isIvandisFlail, isLeafBB, isObbyNeck, isObbySet, isObbyWep, isSalve, isSalveE, isSalveI, isSalveEI, isScythe, isSlayerHelm, isSlayerHelmImbued, isSmokeStaff, isTbow, isTomeOfFire, isVoidMelee, isVoidRange, isVoidRangeElite, isVoidMage, isVoidMageElite, isWildy } = useEquippedGear(state => ({
